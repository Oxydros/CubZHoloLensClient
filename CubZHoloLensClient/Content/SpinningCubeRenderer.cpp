...
void SpinningCubeRenderer::CreateDeviceDependentResources()
{
    ...
    task<void> createCubeTask  = shaderTaskGroup.then([this] ()
    {
        ...
        static const std::array<VertexPositionColor, 5> triangleVertices =
        {{
            { XMFLOAT3(0.0f, 0.1f, 0.0f), XMFLOAT3(0.0f, 1.0f, 1.0f) },
        ...
        constexpr std::array<unsigned short, 18> triangleIndices =
        {{
				0,4,3,
				0,2,3,
				0,4,1,
