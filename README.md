...
# Compilation of Ogre3D

http://wiki.ogre3d.org/tiki-index.php?page=Creating%20a%20Windows%20Store%20App%20using%20OGRE

When you will try to compile you will get an error in OgreTheads.h
Replace all "OGRE_PLATFORM == OGRE_PLATFORM_WIN32" inside this file with "OGRE_PLATFORM == OGRE_PLATFORM_WIN32 || OGRE_PLATFORM == OGRE_PLATFORM_WINRT"
